            ...
            <div class="row justify-content-between">
                <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
                    <div data-aos="zoom-out">
                        <h1>Upgrade Your Knowledge and Skills with <span>PMII</span></h1>
                ...
                <div class="col-lg-4 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="300">
                    <img src="frontend/img/hero-img2.png" class="img-fluid animated" alt="">
                </div>
            </div>
        </div>
    ...
    <main id="main">
        ...
        <section id="about" class="about">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-5 col-lg-4 video-box d-flex justify-content-center align-items-stretch"
                        data-aos="fade-right">
                        <a href="https://www.youtube.com/watch?v=jDDaplaOz7Q" class="venobox play-btn mb-4"
                            data-vbtype="video" data-autoplay="true"></a>
                    </div>

                    <div class="col-xl-7 col-lg-8 col-md-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5"
                        data-aos="fade-left">
                        <h3>Pergerakan Mahasiswa Islam Indonesia</h3>
                        <p>PMII merupakan organisasi gerakan dan kaderisasi yang berlandaskan islam ahlussunah
                            waljamaah. Berdiri sejak tanggal 17 April 1960 di Surabaya oleh 13 pendiri antara lain ...
                        </p>

                        <div class="icon-box" data-aos="zoom-in" data-aos-delay="100">
                            <div class="icon"><i class="bx bx-user-circle"></i></div>
                            <h4 class="title"><a href="">Tujuan PMII</a></h4>
                            <p class="description">Terbentuknya pribadi muslim Indonesia yang bertakwa kepada Allah Swt,
                        ...
                        <div class="icon-box" data-aos="zoom-in" data-aos-delay="200">
                            ...
                            <h4 class="title"><a href="">Format Diri PMII</a></h4>
                            <p class="description"><b>Tri Motto:</b> Dzikir, Fikir, dan Amal Sholeh
                                <br><b>Tri Khidmat:</b> Taqwa, Intelektual, dan Profesional
                                <br><b>Tri Komitmen:</b> Kejujuran, Kebenaran, dan Keadilan</p>
                        </div>
        ...
        {{-- <section id="testimonials" class="testimonials">
            <div class="container">
                ...
                <div class="hero-slider swiper-container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row" data-aos="fade-left">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="box" data-aos="zoom-in" data-aos-delay="100">
                            <img src="assets/img/gallery/gallery-2.jpg" alt="" width="100%" class="mb-3"
                                data-aos="zoom-in">
                            <!-- <h3>Free</h3> -->
                            <h5>Ngomong opo awakmu bos cek wani mrene wae</h5>
                            <ul>
                                <li>Tanggal 2021 | 11 dilihat</li>
                    ...
                    <div class="col-lg-4" data-aos="fade-right" data-aos-delay="100">
                        <div class="info">
                            <div class="address">
                                ...
                                <h4>Location:</h4>
                                <p>Jl. Salemba, Jakarta Pusat, Indonesia</p>
                            </div>
